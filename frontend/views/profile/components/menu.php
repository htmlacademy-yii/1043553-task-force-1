...
<section class="menu-toggle">
    <ul class="menu-toggle__list">
        <li id="completed" class="menu-toggle__item menu-toggle__item--completed">
            ...
            <a href="<?= Url::to([
                'tasks-history/index',
                'status' => Task::STATUS_ACCOMPLISHED,
            ]); ?>">
                Завершённые
            </a>
        </li>
        <li id="new" class="menu-toggle__item menu_toggle__item--current menu-toggle__item--new">
            <div class="menu-toggle__svg-wrapper">
        ...
        <li id="active" class="menu-toggle__item menu-toggle__item--active">
            <div class="menu-toggle__svg-wrapper">
        ...
        <li id="cancelled" class="menu-toggle__item menu-toggle__item--canceled">
            <div class="menu-toggle__svg-wrapper">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <li id="failed" class="menu-toggle__item menu-toggle__item--hidden">
            <div class="menu-toggle__svg-wrapper">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
